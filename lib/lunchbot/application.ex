defmodule Lunchbot.Application do
  ...
  def start(_type, _args) do
    ...
    children = [
      ...
      {Lunchbot.API, [cleartext_options]},
      {Lunchbot.API, [secure_options]},
  ...
  defp certificate_path() do
    Application.app_dir(:lunchbot, "priv/localhost/certificate.pem")
  end

  defp certificate_key_path() do
    Application.app_dir(:lunchbot, "priv/localhost/certificate_key.pem")
  end
end
